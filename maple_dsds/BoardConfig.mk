...
include vendor/sony/yoshino/maple_dsds/BoardConfigVendor.mk

DEVICE_PATH := device/sony/yoshino/maple_dsds
DEVICE_PLATFORM_PATH := device/sony/yoshino
...
TARGET_PREBUILT_KERNEL := $(DEVICE_PLATFORM_PATH)/platform/maple/prebuilt/Image.gz-dtb
